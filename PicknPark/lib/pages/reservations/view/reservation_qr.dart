...
class ReservationQR extends StatefulWidget {
  final int reservationId;
  final bool fromNewBooking;
  final bool fromEditBooking;
  const ReservationQR({Key? key, required this.reservationId,
    this.fromNewBooking = false, this.fromEditBooking = false}) : super(key: key);

  @override
  State<ReservationQR> createState() => _ReservationQRState();
}

class _ReservationQRState extends State<ReservationQR> {
  @override
